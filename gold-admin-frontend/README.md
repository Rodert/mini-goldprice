...
**展示页面**（无需登录）：
- 访问 `http://localhost:8080/display` 查看金价展示页面
- 适用于店铺电子屏、数字标牌等场景
- 详细说明见 [金价展示页面使用指南.md](金价展示页面使用指南.md)
...
**使用步骤**:
1. 将视频文件放到 `public/assets/jewelry-video.mp4`
2. 将产品图片放到 `public/assets/product1.jpg` ~ `product5.jpg`
3. 访问 `http://localhost:8080/display`
4. 按 F11 进入全屏模式

详细说明请查看 [金价展示页面使用指南.md](金价展示页面使用指南.md)
